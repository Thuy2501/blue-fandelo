  ...
  var div = document.createElement('div')
    ...
    div.innerHTML = `
      <figure class="card bg-light">
        <img src="${data.image}" alt="Sunset and boats" />
        ...
        <div class="card-footer bg-light d-flex">
          <div>
            <span class="text-black-50 fw-semibold">${data.timeold}</span>
            <span class="badge border border-dark text-dark p-2 text-uppercase">tickets</span>
          </div>
